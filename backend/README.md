...
## Project Structure
    ...
    ├── testapiautoteammemb_54753  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_54753`
...
2. Clone this repo and `cd testapiautoteammemb_54753`
